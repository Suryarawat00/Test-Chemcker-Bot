...
$url = "https://api.telegram.org/bot7495132028:AAHMrEA4l3BGSLpiMSqoC4UDxp9UsSmeNsI/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
